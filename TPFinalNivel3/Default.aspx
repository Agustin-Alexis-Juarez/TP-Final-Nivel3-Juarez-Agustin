                    ...
                    <div class="col mb-4">
                        <div class="card sombra-card h-100" style="width: 18rem; margin: 0 auto;">
                            ...
                            <div class="card-body">
                                ...
                                <asp:Button ID="btnDetalles" CssClass="btn-detalles" Text="Ver Detalles" OnClick="btnDetalles_Click" CommandArgument='<%#Eval("Id") %>' CommandName="ArticuloId" runat="server" />
                           </div>
                       </div>
                   </div>
               </ItemTemplate>
